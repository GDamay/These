...
\begin{definition}[Gini index and Gini gain]
    The \define{Gini index} of a set $P = \{(p_1, b_1), \dots\allowbreak (p_n, b_n)\}$ of objects $p_i$ associated with classes $b_i \in C = \{c_1, \dots c_l\}$ is the sum of the squared proportion objects in the set that belong to each class.
    \begin{equation}
...
\begin{definition}[Entropy and information gain]
    The \define{entropy} of a set $P = \{(p_1, b_1),\allowbreak\dots (p_n, b_n)\}$ of objects $p_i$ associated with classes $b_i \in C = \{c_1, \dots c_l\}$ is defined by
    \begin{equation}
