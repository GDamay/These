...
\newcommand{\PhDTitle}{TODO: Title}

%% Civilité, nom et prénom /  Civility, first name and name 
\newcommand{\PhDname}{Gabriel Damay}
...
\newcommand{\NNT}{TODO: 20XXIPPAXXXX}

%% Nom de l'ED : École doctorale de l'Institut Polytechnique de Paris, École doctorale de mathématiques Hadamard  / Full name of Doctoral School : École doctorale de l'Institut Polytechnique de Paris, École doctorale de mathématiques Hadamard
\newcommand{\ecodoctitle}{École doctorale de l'Institut Polytechnique de Paris}

%% Sigle de l'ED : EDIPP, EDMH / Acronym of the Doctoral School : EDIPP, EDMH
\newcommand{\ecodocacro}{EDIPP}

%% Numéro de l'école doctorale : 626 (EDIPP), 574 (EDMH) / Doctoral School number : 626 (EDIPP), 574 (EDMH)
\newcommand{\ecodocnum}{626}

%% Spécialité de doctorat / Speciality 
\newcommand{\PhDspeciality}{TODO: voir spécialités par l'ED}
...
\newcommand{\PhDworkingplace}{Télécom Paris}

%% Ville de soutenance / Place of defense
\newcommand{\defenseplace}{Palaiseau}

%% Date de soutenance / Date of defense
\newcommand{\defensedate}{TODO: Date}
...
%% Logo de l'établissement de soutenance. Le nom du fichier correspond au sigle de l'établissement : ENSAE, ENSTA, TP, TSP, X  / Institution logo. Filename correspond to institution acronym : ENSAE, ENSTA, HEC, TP, TSP, X
\newcommand{\logoEt}{TP}

%% À modifier au besoin pour aligner le logo verticalement / If needed, modify to align logo vertilcally
\newcommand{\vpos}{0.1}

%% À modifier au besoin pour aligner le logo horizontalement / If needed, modify to align logo horizontaly
...
\newcommand{\jurynameA}{TODO: Prénom Nom}
...
\newcommand{\jurynameE}{Mauro Sozio}
\newcommand{\juryadressE}{TODO: Statut, Établissement (Unité de recherche)}
\newcommand{\juryroleE}{Directeur de thèse}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{TODO: Prénom Nom}
...
\newcommand{\jurynameG}{TODO: Prénom Nom}
...
\newcommand{\jurynameH}{TODO: Prénom Nom}
